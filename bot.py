...
class TwitchBot(object):
    def __init__(self):
        ...
        self._bot_token = Token('bot', self.config['CLIENT_ID'], self.config['CLIENT_SECRET'], self.config['BOT_CODE'])
        self._stream_token = Token('stream', self.config['CLIENT_ID'], self.config['CLIENT_SECRET'], self.config['STREAM_CODE'])
